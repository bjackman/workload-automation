...
class YoutubePlayback(ApkWorkload):
    ...
    time. This is therefore only useful when you are confident when you are
    confident that the content on the end of the provided URL is stable - that
    means the video should have no advertisements attached.
    """
    ...
    def setup(self, context):
        ...
        self.target.screen.set_orientation(portrait=False)
    ...
    def teardown(self, context):
        super(YoutubePlayback, self).teardown(context)
